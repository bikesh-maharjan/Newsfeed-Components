...
function articleMaker(articleArr) {
  ...
  articleTitle.textContent = articleArr.title;
  articleDate.textContent = articleArr.date;
  articleParagraph1.textContent = articleArr.firstParagraph;
  articleParagraph2.textContent = articleArr.secondParagraph;
  articleParagraph3.textContent = articleArr.thirdParagraph;
